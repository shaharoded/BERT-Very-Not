...
class BaselineTrainer:
    """Trainer for baseline BERT model on SNLI + MNLI datasets"""
    ...
    def __init__(self, model_name: str = 'bert-base-uncased', num_labels: int = 3, gpu_id: int = 3):
        ...
        logger.info(f"Initialized baseline model on device: {self.device}")
    ...
    def train(self, train_data: List[Dict], val_data: List[Dict] = None,
             ...
             save_path: str = "baseline_model.pt") -> Dict[str, List[float]]:
...
def main():
    ...
    parser.add_argument('--learning_rate', type=float, default=2e-5,
                       help='Learning rate')
    parser.add_argument('--save_path', type=str, default='baseline_model.pt',
    ...
    trainer = BaselineTrainer(model_name=args.model_name, gpu_id=args.gpu)
    ...
    # Plot training history
    plot_training_history(history, f"baseline_training_history.png")
